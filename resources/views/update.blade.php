...
<h3 style="text-align: center;">Update Peserta</h3>
<!-- Table -->
<div class="container">
    <a href="/"> Kembali</a>
  <form action="/kirim/{{ $data["id"] }}" method="POST">
    @csrf
    ...
    <div class="mb-3">
        ...
        <input type="number" name="no_hp" value="{{ $data["no_hp"] }}" class="form-control" id="exampleInputPassword1">
      </div>
